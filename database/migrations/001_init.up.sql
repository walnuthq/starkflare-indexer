...
CREATE TABLE starkflare_api.account_calls (
    ...
    entrypoint_selector VARCHAR(66) NOT NULL,
    l1_gas INTEGER NOT NULL,
    l1_data_gas INTEGER NOT NULL,
...
grant select on starkflare_api.account_calls to starkflare_web_anon;
